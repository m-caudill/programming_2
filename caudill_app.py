...
# Headings
st.markdown("# Welcome! Let's predict LinkedIn Users")
st.markdown("#### Use this application to determine whether an individual may be a LinkedIn user based on certain criteria")
